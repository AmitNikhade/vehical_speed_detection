...
carCascade = cv2.CascadeClassifier(r'C:\Users\amitn\gitrepos\vehical_speed_detection\c.xml')
video = cv2.VideoCapture(r'C:\Users\amitn\OneDrive\Desktop\New folder\cars.mp4')
